...
$result = mysqli_query($mysqli, "SELECT * FROM register WHERE d_dept='Civil'"); // using mysqli_query instead
?>
...
<div class="content1">
	...
	<table border=2 class="table1" align="center">
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td><a href=\"civil_delete.php?email=$res[email]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
	}
	?>
	</table>
</div>
