...
$result = mysqli_query($mysqli, "SELECT * FROM register WHERE d_dept='Mechanical'"); // using mysqli_query instead
?>
...
<div class="content1">
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td><a href=\"mech_delete.php?email=$res[email]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
	}
	?>
	</table>
</div>
