...
$result = mysqli_query($mysqli, "SELECT * FROM register WHERE d_dept='Electronics & Telecommunication'"); // using mysqli_query instead
?>
...
<div class="content" style="overflow-x:auto;">
	<h1 align='center'>ELECTRONICS & TELECOMMUNICATION DEPARTMENT</h1>
<br>
...
<div class="content1">
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td><a href=\"etrx_delete.php?email=$res[email]\" onClick=\"return confirm('Are you sure you want to delete?') http_redirect(etrx.php)\">Delete</a></td>";		
	}
	?>
	</table>
</div>
