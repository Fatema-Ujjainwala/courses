...
$result = mysqli_query($mysqli, "SELECT * FROM register WHERE d_dept='Electronics'"); // using mysqli_query instead
?>
...
<div class="content" style="overflow-x:auto;">
	<h1 align='center'>ELECTRONICS DEPARTMENT</h1>
<br>
...
<div class="content1">
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td><a href=\"ex_delete.php?email=$res[email]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
	}
	?>
	</table>
</div>
